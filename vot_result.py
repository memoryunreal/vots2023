...
gt_mask_list = os.listdir("/home/dataset/vots2023/gt_mask")
...
while True:
    ...
    # if not len(new_masks) == len(trackers):
        # print("{}", seq_name, file=open("/home/dataset/vots2023/error.txt", "a"))
        # break
    handle.report([new_masks[i].astype(np.uint8) for i,tracker in enumerate(trackers)])
