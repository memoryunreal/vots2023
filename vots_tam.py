...
# sequence_name = imagefile.split("/")[-3]


# # os.makedirs("/home/lizhe/paper/vots2023/mask_vis/{}".format(sequence_name),exist_ok=True)
# # a = [Image.fromarray(objects[i]).save("/home/lizhe/paper/vots2023/mask_vis/{}/object{}.png".format(sequence_name, i)) for i in range(len(objects))]
# # image_wb = objects[0] * 255
# # Image.fromarray(image_wb).save("/home/lizhe/paper/vots2023/mask_vis/object0_wb.png")

# image = cv2.imread(imagefile, cv2.IMREAD_GRAYSCALE)
# try:
#     assert objects[0].shape == image.shape
# except:
#     with open("/home/lizhe/paper/vots2023/error_gt.txt", "a") as f:
...
#     image = cv2.imread(imagefile, cv2.IMREAD_GRAYSCALE)
#     print("ok")
#     handle.report([objects[i] for i in range(len(objects))])
